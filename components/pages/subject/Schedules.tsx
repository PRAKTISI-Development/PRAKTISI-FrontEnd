    ...
    <>
      <div className="card mb-5">
        <div className="flex flex-col items-start sm:flex-row sm:justify-between sm:items-center">
          ...
          <Link className="text-center text-gray font-medium bg-success rounded py-2 px-5 w-auto block" href="/mata-kuliah/1/jadwal/tambah">
            <FontAwesomeIcon icon={faAdd} />
            <span className="ml-3">Buat Pertemuan</span>
          </Link>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-5">
        <div className="card flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-3.5">
            <Link className="hover:text-primary" href="/mata-kuliah/1/jadwal/1/edit">
              Edit
            </Link>
            <DeleteButton />
            <Link className="hover:text-primary" href="/mata-kuliah/1/jadwal/1">
              Lihat Lengkap
            </Link>
          </div>
        </div>
