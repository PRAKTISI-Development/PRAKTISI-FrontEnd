...
export default function AddTaskPage() {
  return (
    <>
      <Breadcrumb
        pageName="Edit Tugas"
        pages={['Mata kuliah', 'PPW A2 2022', 'Edit tugas']}
            ...
            <div className="p-6.5">
              <div className="mb-4.5">
                <label className="mb-3 block text-black dark:text-white">
                  Jenis tugas <span className="text-meta-1">*</span>
                </label>
              ...
              <div className="mb-4.5">
                <label className="mb-2.5 block text-black dark:text-white">
                  Nama tugas <span className="text-meta-1">*</span>
                </label>
                <input
                  type="text"
              ...
              <div className="mb-4.5">
                <label className="mb-2.5 block text-black dark:text-white">
                  Deskripsi tugas <span className="text-meta-1">*</span>
                </label>
                <Editor />
              </div>
              ...
              <div className="mb-4.5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <div>
                    <label className="mb-2.5 block text-black dark:text-white">
                      Waktu <span className="text-meta-1">*</span>
                    </label>
                    <input
                      type="time"
                      className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
              ...
              <button type="submit" className="flex w-full justify-center items-center rounded bg-primary p-3 font-medium text-gray">
                ...
                <span className="ml-3">Edit Tugas</span>
              </button>
            </div>
          </form>
        </div>
